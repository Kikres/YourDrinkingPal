...
public class CommonServicePassword
{
    private readonly int _passwordLength;

    public CommonServicePassword(IConfiguration configuration)
    {
        _passwordLength = int.Parse(configuration["Password:Length"]);
    }
    ...
    public string GeneratePassword()
    {
        ...
        randomNumberGenerator.GetBytes(rgb);
